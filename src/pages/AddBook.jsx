  ...
  return (
    ...
    <div className="bg-white/80 w-full md:w-3/4 lg:w-2/3 xl:w-1/2 rounded-xl shadow-2xl overflow-hidden">
      ...
      <div className="p-8">
        <form>
          <div className="mb-6">
            <label className="block text-lg font-bold text-black-700 mb-2">Book Title</label>
            <input
              type="text"
          ...
          <div className="mb-6">
            <label className="block text-lg font-bold text-black-700 mb-2">Author</label>
            <input
              type="text"
          ...
          <div>
              <label className="block text-lg font-bold text-black-700 mb-2">Genre</label>
              <input
                type="text"
                className="w-full px-4 py-3 rounded-lg border border-gray-500 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 shadow-sm"
                required
            ...
            <div>
              <label className="block text-lg font-bold text-black-700 mb-2">Year of Publication</label>
              <input
                type="date"
                className="w-full px-4 py-3 rounded-lg border border-gray-500 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 shadow-sm"
                required
          ...
          <div>
              <label className="block text-lg font-bold text-black-700 mb-2">Image</label>
              <input
                type="file"
                className="w-full px-4 py-3 rounded-lg border border-gray-500 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 shadow-sm "
                required
          ...
          <div className="mb-6">
            <label className="block text-lg font-bold text-black-700 mb-2">Description</label>
            <textarea
          ...
          <div className="mb-8">
            <label className="block text-sm font-bold text-black-700 mb-3">Rating</label>
            <div className="flex gap-2">
              {[1, 2, 3, 4, 5].map((star) => (
                <svg key={star} className="w-8 h-8 text-gray-500 cursor-pointer hover:text-yellow-400 transition duration-150" fill="currentColor" viewBox="0 0 20 20">
